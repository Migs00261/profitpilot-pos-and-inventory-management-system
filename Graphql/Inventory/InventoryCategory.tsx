...
mutation UPDATECATEGORY($mycategoryId:String!,$myuserId:String!,$mycategory:String,$mydescription:String){
    updateCategory(id:$mycategoryId,userId:$myuserId,category:$mycategory,description:$mydescription){
        id
        userId
        category
        description
